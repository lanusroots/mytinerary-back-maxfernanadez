...
import logger from 'morgan'                                   //para registrar cada una de las peticiones q llegan al servidor
//var indexRouter = require('./routes/index')                 //solo vamos a configurar las rutas del enrutador de back principal
import indexRouter from './routes/index.js'                   //este enrutador va a llamar a TODOS los otros recuersos (users, cities, etc)"NO OLVIDAR EXTENCION(.js)"
